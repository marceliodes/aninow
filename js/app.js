...
function initializeShell() {
  ...
  if (footer) footer.innerHTML = `<div class="shell footer-inner"><p class="footer-copy"><strong>AniNow</strong> · Rankings and anime metadata provided by MyAnimeList. Episode airing information may be supplemented by AniList. AniNow is not affiliated with or endorsed by either service.</p><nav class="footer-links" aria-label="Footer"><a href="/privacy">Privacy</a><a href="https://github.com/marceliodes/aninow" target="_blank" rel="noopener noreferrer">GitHub</a></nav></div>`;
