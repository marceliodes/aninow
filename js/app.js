...
function initializeShell() {
  ...
  if (footer) footer.innerHTML = `<div class="shell footer-inner"><p class="footer-copy"><strong>AniNow</strong> · Anime data sourced from MyAnimeList via Jikan. AniNow is not affiliated with MyAnimeList.</p><nav class="footer-links" aria-label="Footer"><a href="/about.html">About</a><a href="/privacy.html">Privacy</a><a href="https://github.com/jikan-me/jikan" target="_blank" rel="noopener noreferrer">Jikan ↗</a></nav></div>`;
